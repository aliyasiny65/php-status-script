...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO users (email, password) VALUES ('$email', '$encpass')";
	$sqldel = "DELETE FROM users WHERE email='$usermail'";
        if(mysqli_query($conn, $sql)){
            echo "New user records added.\n";
        } else {
		...
		if(mysqli_query($conn, $sqldel)){
		    ...
		    echo "ERROR: Could not able to execute $sqldel. " . mysqli_error($conn);
		}
        mysqli_close($conn);
};
?>
