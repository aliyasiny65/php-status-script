<?php
if(file_exists("update_after_run.php")) {
	header("Location: update_after_run.php");
}
    include "../config.php";
    session_start();
	...
	$changelog = file_get_contents("https://cdn.aliyasin.org/status/changelog.txt");
	if(!$changelog) {
	...
	copy("$docroot/api.php", "$docroot/admin/backup/api.php");
	...
	copy("$docroot/language.json", "$docroot/admin/backup/language.json");
	...
	copy("$docroot/admin/custom-javascript.php", "$docroot/admin/backup/admin/custom-javascript.php");
	copy("$docroot/admin/delete-report.php", "$docroot/admin/backup/admin/delete-report.php");
	copy("$docroot/admin/edit-analytics.php", "$docroot/admin/backup/admin/edit-analytics.php");
	copy("$docroot/admin/edit-config.php", "$docroot/admin/backup/admin/edit-config.php");
	copy("$docroot/admin/new-account.php", "$docroot/admin/backup/admin/new-account.php");
	copy("$docroot/admin/updater.php", "$docroot/admin/backup/admin/updater.php");
          ...
          <div class="page-header d-print-none">
			...
			<form method=\"POST\" class=\"\">
				<div class=\"text-center mt-4\">
					<button name=\"button\" id=\"button\" class=\"lang btn\" key=\"updateinstall\">Update Install</button>
				</div>
			</form>
			<div></div><h4></h4>
			<div class=\"col-12\">
              <div class=\"card\">
                <div class=\"card-header\">
                  <h3 class=\"lang card-title\" key=\"changelog\">ChangeLog:</h3>
                </div>
                <div class=\"card-body\" style=\"display: block;width: 200px;\">
