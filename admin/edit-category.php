...
$ctg3 = $_POST['ctg3'];
if($ctg1 === " ") {
	$ctg1 = $findById("category1");
}
if($ctg2 === " ") {
	$ctg2 = $findById("category2");
}
if($ctg3 === " ") {
	$ctg3 = $findById("category3");
}
if (isset($_POST['submit'])) {
    ...
    foreach ($json_arro as $keyo => $valueo) {
        if ($valueo['id'] == "category1") {
            $json_arro[$keyo]['name'] = $ctg1;
        }
		if ($valueo['id'] == "category2") {
            $json_arro[$keyo]['name'] = $ctg2;
        }
		if ($valueo['id'] == "category3") {
            $json_arro[$keyo]['name'] = $ctg3;
        }
    }
...
$fp = fopen('log.txt', 'w');
fwrite($fp, "User: ".$_SESSION["email"]." Action: Editing Category | IP Address: $ip | User Agent: ".$_SERVER['HTTP_USER_AGENT']." Date: ".date("M/d/Y H:i:s")."\n".$getlogfile);
fclose($fp);
};
?>
							...
							<div class="col-xl-4">
				            	<div class="row">
									<div class="col-md-6 col-xl-12">
										<div class="mb-3">
				                		<label class="form-label"><h class="lang" key="ctg1">Category 1</h> (<?php echo($findById("category1")); ?>)</label>
				                		<input type="text" class="form-control" placeholder="New Category Name" name="ctg1" value="<?php echo $_POST['ctg1']; ?>" required>
				            		</div>
									<div class="col-md-6 col-xl-12">
										<div class="mb-3">
				                		<label class="form-label"><h class="lang" key="ctg2">Category 2</h> (<?php echo($findById("category2")); ?>)</label>
				                		<input type="text" class="form-control" placeholder="New Category Name" name="ctg2" value="<?php echo $_POST['ctg2']; ?>" required>
				            		</div>
									<div class="col-md-6 col-xl-12">
										<div class="mb-3">
				                		<label class="form-label"><h class="lang" key="ctg3">Category 3</h> (<?php echo($findById("category3")); ?>)</label>
				                		<input type="text" class="form-control" placeholder="New Category Name" name="ctg3" value="<?php echo $_POST['ctg3']; ?>" required>
				            		</div>
