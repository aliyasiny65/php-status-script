	...
	<div class="container">
		<form action="" method="POST" class="login-email">
			...
			<div class="input-group">
				<input type="text" placeholder="Incident Name" name="incname" value="<?php echo $_POST['incname']; ?>" required>
			</div>
			<div class="input-group">
				<input type="text" placeholder="Incident Information" name="info" value="<?php echo $_POST['info']; ?>" required>
			</div>
            <div class="input-group">
            <select class="contact-form__input contact-form__input--select" id="ctg" name="ctg" value="<?php echo $_POST['ctg']; ?>" required>
