...
if (isset($_POST['submit'])) {
	...
	$fp = fopen('log.txt', 'w');
	fwrite($fp, "User: ".$_SESSION["email"]." Action: Create Incident | IP Address: $ip | User Agent: ".$_SERVER['HTTP_USER_AGENT']." Date: ".date("M/d/Y H:i:s")."\n".$getlogfile);
	fclose($fp);
...
<html lang="en">
  <head>
    ...
    <title><?php echo($sname) ?> Admin | Create Incident</title>
    				...
    				<div class="col-xl-4">
    	            	<div class="row">
    						<div class="col-md-6 col-xl-12">
    							<div class="mb-3">
    	                		<label class="lang form-label" key="incname">Incident Name</label>
    	                		<input type="text" name="incname" class="form-control" placeholder="Incident Name" required>
    	            		</div>
    						<div class="col-md-6 col-xl-12">
    							<div class="mb-3">
    	                		<label class="lang form-label" key="incinfo">Incident Information</label>
    	                		<input type="text" class="form-control" placeholder="Incident Information" name="info">
    	            		</div>
                            <div class="mb-3">
