      ...
      <div class="col-12">
          <div class="table-responsive">
    		<table id='table' class="table table-vcenter card-table">
    		    <tr>
    		        <th class="lang" key="reportid">Report ID</th>
    		        <th class="lang" key="username">User Name</th>
    		        <th class="lang" key="affectedserv">Affected Service</th>
    		        <th class="lang" key="info">Information</th>
					<th class="lang" key="reportdate">Report Date</th>
            	    ...
            	    $(document).ready(function () {
            	        $.getJSON("../reports.json", 
            	            ...
            	            $.each(data, function (key, value) {
								...
								student += '<td>' + '<a class="lang btn" key="deletereport" href="delete-report.php?id=' + value.id + '">' + 'Delete Report' + '</a>' + '</td>';
