          ...
          <div class="page-header d-print-none">
            <div class="row align-items-center">
              <div class="col">
				...
				<h class="lang" key="overview">Overview</h>
                </div>
                <h2 class="page-title">
				<h class="lang" key="dashb">Dashboard</h>
                </h2>
              </div>
              <!-- Page title actions -->
          ...
          <div class="container-xl">
              <div class="col-lg-6">
				...
				<div class="card-header border-0">
                    <div class="lang card-title" key="activity">Activity</div>
                  </div>
                  <div class="card-table table-responsive">
                    <table class="table table-vcenter">
                      <thead>
                        <tr>
                          <th class="lang" key="incstatus">Incident Status</th>
                          <th class="lang" key="date">Date</th>
                          <th class="lang" key="actions">Actions</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td class="td-truncate">
                            <div class="text-truncate">
                              ...
                              if($control5 == "") {
                                echo("<h class=\"lang\" key=\"noincreported\">No incidents reported.</h>");
                              } else {
